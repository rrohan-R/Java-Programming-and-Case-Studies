...
insert into product(product_name,price,coffee_origin)
values ('espresso',2.50,'brazil'), ('macchiatto',3.00,'brazil'),('cappuccino',3.50,'costa rica'),('latte',3.50,'indonesia'),
		('americano',3.00,'brazil'),('flat white',3.50,'indonesia'),('filter',3.00,'india'),("affogato",2.70,"Italy"),("Frappe",3.50,"Greece");

#From the products table, display the names of the products having origin from ‘India’ or ‘indonesia'
select product_name
from product
where coffee_origin="India";
